...
from mmcv.cnn import ConvModule, DepthwiseSeparableConvModule, Scale, NonLocal2d
...
class DepthwiseSeparableASPPHead(ASPPHead):
    ...
    def forward(self, inputs):
        ...
        # if self.c1_nl is not None:
        #     c1_output = self.c1_nl(inputs[0])
        #     output = resize(
        #         input=output,
        #         size=inputs[0].shape[2:],
        #         mode='bilinear',
